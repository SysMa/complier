...
private final int jjStopStringLiteralDfa_0(int pos, long active0)
{
   switch (pos)
   {
      ...
      case 1:
         ...
         return -1;
      case 2:
         if ((active0 & 0x77d5f0000000L) != 0L)
         {
            jjmatchedKind = 47;
            jjmatchedPos = 2;
            return 6;
         }
         if ((active0 & 0x82800000000L) != 0L)
            return 6;
         return -1;
      case 3:
         if ((active0 & 0x571040000000L) != 0L)
            return 6;
         if ((active0 & 0x20c5b0000000L) != 0L)
         {
            jjmatchedKind = 47;
            jjmatchedPos = 3;
            return 6;
...
private int jjMoveStringLiteralDfa0_0()
{
   switch(curChar)
   {
      ...
      case 47:
         return jjStartNfaWithStates_0(0, 22, 8);
      case 58:
      ...
      case 108:
         return jjMoveStringLiteralDfa1_0(0x201000000000L);
      case 109:
...
private int jjMoveStringLiteralDfa1_0(long active0)
{
   ...
   switch(curChar)
   {
      ...
      case 101:
         return jjMoveStringLiteralDfa2_0(active0, 0x206000000000L);
      case 102:
         if ((active0 & 0x200000000L) != 0L)
      ...
      case 111:
         return jjMoveStringLiteralDfa2_0(active0, 0x141010000000L);
      case 114:
...
private int jjMoveStringLiteralDfa2_0(long old0, long active0)
{
   ...
   switch(curChar)
   {
      ...
      case 101:
         ...
         break;
      case 105:
         return jjMoveStringLiteralDfa3_0(active0, 0x450400000000L);
      case 108:
...
static final int[] jjnextStates = {
   8, 13, 20, 21, 22, 9, 10, 12, 16, 18, 
};

/** Token literal values. */
public static final String[] jjstrLiteralImages = {
"", null, null, "\40", "\11", null, null, null, "\50", "\51", "\133", "\135", 
"\173", "\175", "\73", "\56", "\74\75", "\74", "\76", "\53", "\55", "\52", "\57", 
"\46\46", "\174\174", "\41", "\54", "\72", "\142\157\157\154\145\141\156", 
"\143\154\141\163\163", "\145\154\163\145", "\145\170\164\145\156\144\163", "\146\141\154\163\145", 
"\151\146", "\167\150\151\154\145", "\151\156\164", "\154\157\156\147", "\156\145\167", 
"\162\145\164\165\162\156", "\163\164\141\164\151\143", "\164\150\151\163", "\164\162\165\145", 
"\166\157\151\144", "\160\162\145", "\160\157\163\164", "\154\145\156\147\164\150", 
"\155\141\151\156", null, null, null, null, null, };
...
public Token getNextToken() 
{
  ...
  for (;;)
  {
   ...
   if (jjmatchedKind != 0x7fffffff)
   {
      ...
      {
         matchedToken = jjFillToken();
         if (matchedToken.kind == ILL_ID){
        	 throw new TokenMgrError(matchedToken, TokenMgrError.ILLEGAL_IDENTIFIERS);
         }
         else{
        	 return matchedToken;
         }
   ...
   try {
	   if ("".equals(error_after)) {
		   input_stream.backup(1);
		   error_after += input_stream.readChar();
	   }
   } 
   catch (java.io.IOException e1) {
