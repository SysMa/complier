/* Generated By:JJTree&JavaCC: Do not edit this line. XYZCompilerTokenManager.java */
package com.lexAndParse;
import java.util.HashMap;
import java.util.Map;

/** Token Manager. */
public class XYZCompilerTokenManager implements XYZCompilerConstants
{
   ...
   switch (pos)
   {
      case 0:
         if ((active0 & 0x1000000L) != 0L)
            return 3;
         if ((active0 & 0x1ffffc0000000L) != 0L)
         {
            jjmatchedKind = 49;
            return 1;
         }
      ...
      case 1:
         if ((active0 & 0x800000000L) != 0L)
            return 1;
         if ((active0 & 0x1fff7c0000000L) != 0L)
         {
            jjmatchedKind = 49;
            jjmatchedPos = 1;
            return 1;
         ...
         return -1;
      case 2:
         if ((active0 & 0x20a000000000L) != 0L)
            return 1;
         if ((active0 & 0x1df57c0000000L) != 0L)
         {
            jjmatchedKind = 49;
            jjmatchedPos = 2;
            return 1;
         ...
         return -1;
      case 3:
         if ((active0 & 0x15c4100000000L) != 0L)
            return 1;
         if ((active0 & 0x8316c0000000L) != 0L)
         {
            jjmatchedKind = 49;
            jjmatchedPos = 3;
            return 1;
         ...
         return -1;
      case 4:
         if ((active0 & 0x1480000000L) != 0L)
            return 1;
         if ((active0 & 0x830240000000L) != 0L)
         {
            jjmatchedKind = 49;
            jjmatchedPos = 4;
            return 1;
...
private int jjMoveStringLiteralDfa1_0(long active0)
{
   ...
   switch(curChar)
   {
      ...
      case 61:
         ...
         break;
      case 97:
         return jjMoveStringLiteralDfa2_0(active0, 0x1000400000000L);
      case 101:
         return jjMoveStringLiteralDfa2_0(active0, 0x818000000000L);
      case 102:
         if ((active0 & 0x800000000L) != 0L)
      ...
      case 111:
         return jjMoveStringLiteralDfa2_0(active0, 0x504040000000L);
      case 114:
...
private int jjMoveStringLiteralDfa2_0(long old0, long active0)
{
   ...
   switch(curChar)
   {
      ...
      case 101:
         ...
         break;
      case 105:
         return jjMoveStringLiteralDfa3_0(active0, 0x1141000000000L);
      case 108:
...
"\133", "\135", "\173", "\175", "\73", "\56", "\74\75", "\74", "\76", "\53", "\55", 
"\52", "\57", "\46\46", "\174\174", "\41", "\54", "\72", 
"\142\157\157\154\145\141\156", "\143\154\141\163\163", "\145\154\163\145", "\145\170\164\145\156\144\163", 
"\146\141\154\163\145", "\151\146", "\167\150\151\154\145", "\151\156\164", "\154\157\156\147", 
"\156\145\167", "\162\145\164\165\162\156", "\163\164\141\164\151\143", "\164\150\151\163", 
"\164\162\165\145", "\166\157\151\144", "\160\162\145", "\160\157\163\164", 
"\154\145\156\147\164\150", "\155\141\151\156", null, null, null, null, };
...
/** Constructor. */
public XYZCompilerTokenManager(SimpleCharStream stream){
...
/** Constructor. */
public XYZCompilerTokenManager(SimpleCharStream stream, int lexState){
   this(stream);
   SwitchTo(lexState);
}
